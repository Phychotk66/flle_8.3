...
require_once 'Customweb/Xml/Namespace.php';
require_once 'Customweb/Xml/Binding/DateHandler/IDateFormatable.php';
require_once 'Customweb/Xml/Binding/AbstractCodec.php';
require_once 'Customweb/Core/Exception/CastException.php';
require_once 'Customweb/Core/String.php';
require_once 'Customweb/Xml/ISimpleType.php';
require_once 'Customweb/Xml/Binding/Reflection/Class.php';
require_once 'Customweb/Xml/Nil.php';
...
class Customweb_Xml_Binding_Encoder extends Customweb_Xml_Binding_AbstractCodec {
	...
	private function createElement($name, $namespaceURI, DOMNode $dom, Customweb_Xml_Binding_Reflection_IItem $reflector, $value = ""){
	...
	private function createAttribute($name, $namespaceURI, DOMNode $dom, $value = ''){
