...
require_once 'TwintCw/Adapter/Configuration.php';
...
class TwintCw_LoggingListener implements Customweb_Core_Logger_IListener {
	...
	public function addLogEntry($loggerName, $level, $message, Exception $e = null, $object = null){
		...
		TwintCw_VersionHelper::getInstance()->writeLog($this->mapToJTLLevel($level), $message, 'TwintCw_');
	}

	private function isLevelActive($level){
		switch (TwintCw_Adapter_Configuration::getLoggingLevel() ){
			case 'debug':
				return true;
			case 'info':
