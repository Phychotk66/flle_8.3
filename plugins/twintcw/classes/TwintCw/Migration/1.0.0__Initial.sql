CREATE TABLE IF NOT EXISTS xplugin_twintcw_transactions (
...
CREATE TABLE IF NOT EXISTS `xplugin_twintcw_storage` (
...
CREATE TABLE IF NOT EXISTS xplugin_twintcw_customer_contexts (
...
CREATE TABLE IF NOT EXISTS xplugin_twintcw_constants (
