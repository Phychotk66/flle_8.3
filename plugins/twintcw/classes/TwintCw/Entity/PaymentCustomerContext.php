...
/**
 *
 * @Entity(tableName = 'xplugin_twintcw_customer_contexts')
 *
 */
class TwintCw_Entity_PaymentCustomerContext extends Customweb_Payment_Entity_AbstractPaymentCustomerContext
{
	...
	public static function getPaymentCustomerContext($customerId) {
		...
		if (!isset(self::$paymentCustomerContexts[$customerId])) {
			$entities = TwintCw_Util::getEntityManager()->searchByFilterName('TwintCw_Entity_PaymentCustomerContext', 'loadByCustomerId', array(
