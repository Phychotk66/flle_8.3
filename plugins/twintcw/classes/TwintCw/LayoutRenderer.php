...
class TwintCw_LayoutRenderer implements Customweb_Mvc_Layout_IRenderer {
	...
	public function render(Customweb_Mvc_Layout_IRenderContext $context) {
		...
		$asset = TwintCw_Util::getAssetResolver()->resolveAssetStream('base.tpl');
	...
	protected function getAdditionalResourcesHtml(Customweb_Mvc_Layout_IRenderContext $context) {
		...
		$css[] = 'form.css';
		$output .= TwintCw_Util::buildResourceHtml($css, 'css');
		$output .= TwintCw_Util::buildResourceHtml($context->getJavaScriptFiles(), 'js');
		return $output;
	}
