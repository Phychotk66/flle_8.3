...
class TwintCw_Controller_Form extends TwintCw_Controller_AbstractBackend {
	...
	public function listAction() {
		$forms = array();
		$adapter = TwintCw_Util::getBackendFormAdapter();
		if ($adapter !== null) {
	...
	public function saveAction() {
		...
		TwintCw_Util::getBackendFormAdapter()->processForm($form, $pressedButton, $params);
