...
require_once 'TwintCw/AbstractOrderContext.php';


class TwintCw_SessionOrderContext extends TwintCw_AbstractOrderContext {
	...
	protected function getInvoiceItemsFromSession() {
		return TwintCw_Util::convertJTLItems($_SESSION['Warenkorb']->PositionenArr, $_SESSION['Waehrung']->cISO, $_SESSION['Warenkorb']->gibGesamtsummeWaren(true)*$_SESSION['Waehrung']->fFaktor);
	}
