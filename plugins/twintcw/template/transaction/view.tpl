...
<div class="buttons">
	...
	<?php if (isset($update_url)): ?>
		<a class="btn btn-success" href="<?php echo $update_url;?>">Manuelles Update ausl&ouml;sen</a>
	<?php endif; ?>
...
<table class="table">
	...
	<tr>
		<td><?php echo TwintCw_Language::_('Payment Information') ?></td>
...
<h3><?php echo TwintCw_Language::_('Captures for this transaction'); ?></h3>
<table class="table">
	<thead>
		<tr>
			<th><?php echo TwintCw_Language::_('Date'); ?></th>
			<th><?php echo TwintCw_Language::_('Amount'); ?></th>
			<th><?php echo TwintCw_Language::_('Status'); ?></th>
			<th> </th>
		</tr>
	</thead>
	<tbody>
		...
		<tr>
			...
			<td>
				<a class="button orange" href="<?php echo $this->getUrl(array('transaction_id' => $transaction->getTransactionId(), 'capture_id' => $capture->getCaptureId()), 'viewCapture'); ?>">
					<?php echo TwintCw_Language::_('View'); ?>
				</a>
			</td>
		</tr>
		<?php endforeach;?>
...
<h3><?php echo TwintCw_Language::_('Refunds for this transaction'); ?></h3>
<table class="table">
	<thead>
		<tr>
			<th><?php echo TwintCw_Language::_('Date'); ?></th>
...
<h3><?php echo TwintCw_Language::_('Transactions History'); ?></h3>
<table class="table">
	<thead>
		<tr>
			<th><?php echo TwintCw_Language::_('Date'); ?></th>
			<th><?php echo TwintCw_Language::_('Action'); ?></th>
			<th><?php echo TwintCw_Language::_('Message'); ?></th>
		</tr>
	</thead>
	<tbody>
...
<?php if ($relatedTransactions != null && count($relatedTransactions) > 0): ?>
<h3><?php echo TwintCw_Language::_('Transactions related to the same order'); ?></h3>
<table class="table">
	<thead>
		<tr>
			<th><?php echo TwintCw_Language::_('Transaction Number'); ?></th>
			<th><?php echo TwintCw_Language::_('Is Authorized'); ?></th>
			<th><?php echo TwintCw_Language::_('Authorization Amount'); ?></th>
			<th></th>
		</tr>
	</thead>
	<?php foreach ($relatedTransactions as $transaction): ?>
		...
		<tr>
			<td><?php echo $transaction->getTransactionExternalId(); ?></td>
			<td><?php echo $transaction->getTransactionObject()->isAuthorized() ? TwintCw_Language::_('yes') : TwintCw_Language::_('no'); ?></td>
			<td><?php echo $transaction->getTransactionObject()->getAuthorizationAmount(); ?></td>
			<td><a class="button orange" href="<?php echo $this->getUrl(array('transaction_id' => $transaction->getTransactionId()), 'view'); ?>"><?php echo TwintCw_Language::_('View'); ?></a>
		</tr>
		<?php endif; ?>
	<?php endforeach;?>
</table>
