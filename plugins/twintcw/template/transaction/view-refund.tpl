...
<h3><?php echo TwintCw_Language::_('Refund Data'); ?></h3>
<table class="table">
	<tr>
		<td><?php echo TwintCw_Language::_('Refund ID') ?></td>
		<td><?php echo $refund->getRefundId(); ?></td>
	</tr>

	<tr>
		<td><?php echo TwintCw_Language::_('Refund Date') ?></td>
		<td><?php echo $refund->getRefundedDate()->format($dateFormat); ?></td>
	</tr>
	<tr>
		<td><?php echo TwintCw_Language::_('Refund Amount') ?></td>
...
<h3><?php echo TwintCw_Language::_('Refunded Items'); ?></h3>
<table class="table">
	<thead>
		<tr>
